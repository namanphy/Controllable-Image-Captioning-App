...
Fed up with dull and montonic image captioned generated by machine? 
Tweak Story is an open-source project towards generating controllable Instagram captions. 
- powered by by PyTorch, Transformers and Streamlit. 
- indefinitely tweakable
- mix and match the flavor you want
Tweak Story is mainly powered by PyTorch, Streamlit and Transformer. 
